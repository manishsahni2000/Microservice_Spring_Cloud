package com.my.cloud.stock.stock_service.resource;
...
public class StockResource {
	...
	// this will interact with the db_service service and fetch the username and
	// qoutes using the RestTemplate
	@GetMapping("/{username}")
